...
delete_option('lookout_traces_enabled');
delete_option('lookout_profiling_enabled');
delete_option('lookout_rum_enabled');
delete_option('lookout_cron_monitoring');
delete_option('lookout_logs_enabled');
delete_option('lookout_consent');
delete_transient('lookout_remote_config');
delete_transient('lookout_env_context');
